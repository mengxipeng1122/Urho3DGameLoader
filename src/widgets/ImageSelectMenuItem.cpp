...
void ImageSelectMenuItem::GetBatches(PODVector<UIBatch>& batches, PODVector<float>& vertexData, const IntRect& currentScissor)
{
...
bool ImageSelectMenuItem::HandleKeyDown(InputKey key, int idx)
{
